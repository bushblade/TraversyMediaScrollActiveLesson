...
zip -r firefox-extension.zip . -x "*.git/*" "firefox-extension.zip" "chrome-extension.zip"
echo "Firefox extension zipped as firefox-extension.zip"

# Copy Chrome manifest and create Chrome extension zip
cp manifest.chrome.json manifest.json
zip -r chrome-extension.zip . -x "*.git/*" "firefox-extension.zip" "chrome-extension.zip"
